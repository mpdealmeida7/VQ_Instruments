...
def format_measurement(value, scale=1.0, decimals=3, unit=""):
...
def main():
    ...
    try:
        ...
        scope.print_error_queue("SCPI errors after configuration")
        ...
        scope.print_error_queue("SCPI errors after measurements")
        print()
